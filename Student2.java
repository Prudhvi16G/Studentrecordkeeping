...
class StudentRecords
{
	...
	try
		...
		// Read records from the file
			System.out.println("=======================================================================================================");
			System.out.println("S.No.   Name            F.Name          M.Name  Address        Class      DOB           AGE     Tel.no");
			System.out.println("=======================================================================================================");
			while((name = file.readLine()) != null)
				{
					System.out.println((i++)+"	"+name+"	"+file.readLine()+"	"+file.readLine()+"	"+file.readLine()+" 	"+file.readLine()+"	"+file.readLine()+"	"+Integer.parseInt(file.readLine())+"	"+Long.parseLong(file.readLine()));
					System.out.println();
				}
			file.close();
			showMenu();
